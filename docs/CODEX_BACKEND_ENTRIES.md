...
## Отладочные команды (не зарегистрированы)

Командный интерфейс сохранён в исходниках как отладочная заготовка, но больше не
подключается к `/riftborne`. Обычная работа с Кодексом идёт через его интерфейс.
