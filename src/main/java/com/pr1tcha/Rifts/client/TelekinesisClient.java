...
public final class TelekinesisClient {
    private static final KeyMapping TELEKINESIS_KEY = new KeyMapping(
            "key.riftborne_rift.telekinesis",
            InputConstants.Type.KEYSYM,
            GLFW.GLFW_KEY_V,
            "key.categories.riftborne_rift"
    );
    ...
    @EventBusSubscriber(modid = RiftborneRift.MODID, bus = EventBusSubscriber.Bus.MOD, value = Dist.CLIENT)
    ...
    @EventBusSubscriber(modid = RiftborneRift.MODID, value = Dist.CLIENT)
