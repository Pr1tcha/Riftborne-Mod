...
CONTAINERS = {
    ...
    "Power HUD armed row (160px bar, shares with cost)": (110, [
        "primitive.riftborne.p1_reading",
        "primitive.riftborne.p2_anchor",
        "primitive.riftborne.p3_shift",
        "primitive.riftborne.p4_shape",
        "primitive.riftborne.p5_stabilize",
        "primitive.riftborne.v1_tempo_read",
        "primitive.riftborne.v2_phase_entry",
        "primitive.riftborne.v3_tempo_shift",
        "primitive.riftborne.v4_phase_hold",
    ]),
